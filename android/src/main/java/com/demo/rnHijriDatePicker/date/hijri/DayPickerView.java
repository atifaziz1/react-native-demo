...
import com.demo.rnHijriDatePicker.date.hijri.HijriDatePickerDialog.OnDateChangedListener;
...
public abstract class DayPickerView extends ListView implements OnScrollListener,
    ...
    private static String getMonthAndYearString(MonthAdapter.CalendarDay day, Locale locale) {
        ...
        String sbuf = "";
        sbuf += cal.getDisplayName(UmmalquraCalendar.MONTH, UmmalquraCalendar.SHORT, locale);
        sbuf += " ";
